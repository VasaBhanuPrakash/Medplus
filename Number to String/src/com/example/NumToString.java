                ...
                if (rem != 0) {
                    ...
                    if (rem < 20) {
                        switch (rem) {
                            ...
                            case 10: s = " ten" + s; break;
                            case 11: s = " eleven" + s; break;
                            case 12: s = " twelve" + s; break;
                            case 13: s = " thirteen" + s; break;
                            case 14: s = " fourteen" + s; break;
                            case 15: s = " fifteen" + s; break;
                            case 16: s = " sixteen" + s; break;
                            case 17: s = " seventeen" + s; break;
                            case 18: s = " eighteen" + s; break;
                            case 19: s = " nineteen" + s; break;
                        }
                        n /= 100;
                        x += 2;
                    } else {
